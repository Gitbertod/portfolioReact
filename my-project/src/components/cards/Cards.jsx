      ...
      <div className=" flex justify-center  flex-wrap">
        ...
        <Card
          ...
          text={
            <>
              <p>
                Aplicación web desarrollada con React y Tailwind CSS para la
                empresa MEE. Se implementaron animaciones avanzadas con GSAP y
                una barra de búsqueda optimizada. Enfocada en rendimiento, UX y
                diseño responsivo.
                <br></br>
                <br></br>
              </p>
