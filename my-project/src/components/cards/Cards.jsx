        ...
        <Card
          ...
          text={
            <>
              ...
              usuario fluida y eficiente. El proyecto fue desarrollado con React
              para rutas utilicé React Router y estilos con Tailwind CSS y CSS
              Modules.<br></br>
              <br></br>
              <h3 className={styles.subtitle}>Tecnologías utilizadas: </h3>
            </>
          }
          icons={
